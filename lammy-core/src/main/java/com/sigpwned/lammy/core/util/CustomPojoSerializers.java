 ...
 * ==================================LICENSE_END===================================
 */
package com.sigpwned.lammy.core.util;
...
public final class CustomPojoSerializers {
  ...
  public static CustomPojoSerializer loadSerializer() {
    ...
    if (serializers.hasNext()) {
      // I would prefer to use this class, since that's what the AWS Lambda runtime does, but it
      // throws a ClassNotFoundException during testing. I'm not sure if it's worth working around.
