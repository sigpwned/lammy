...
import io.aleph0.lammy.test.util.CodeGenerating;
...
public interface BeanFunctionTesting extends CodeGenerating {
  ...
  public static final String REQUEST_FILTER_SERVICE_LOADER_JAR_ENTRY_NAME =
      "META-INF/services/io.aleph0.lammy.core.model.bean.RequestFilter";
  ...
  public static final String RESPONSE_FILTER_SERVICE_LOADER_JAR_ENTRY_NAME =
      "META-INF/services/io.aleph0.lammy.core.model.bean.ResponseFilter";
  ...
  public static final String EXCEPTION_MAPPER_SERVICE_LOADER_JAR_ENTRY_NAME =
      "META-INF/services/io.aleph0.lammy.core.model.bean.ExceptionMapper";
   ...
   * <li>Its
   * {@link ExceptionMapper#mapExceptionTo(Exception, java.lang.reflect.Type, io.aleph0.lammy.core.model.bean.Context)}
